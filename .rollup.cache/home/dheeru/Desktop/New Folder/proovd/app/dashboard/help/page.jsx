...
import { QuestionMarkCircleIcon, DocumentTextIcon, ChatBubbleLeftRightIcon, BookOpenIcon, AcademicCapIcon, EnvelopeIcon } from '@heroicons/react/24/outline';
export default function HelpPage() {
    ...
    return (<div className="container mx-auto p-6">
      ...
      <div className="tabs tabs-boxed bg-base-200 mb-6">
        <a className={`tab ${activeTab === 'faq' ? 'tab-active' : ''}`} onClick={() => setActiveTab('faq')}>
          <QuestionMarkCircleIcon className="w-5 h-5 mr-2"/>
          FAQ
        </a>
        <a className={`tab ${activeTab === 'docs' ? 'tab-active' : ''}`} onClick={() => setActiveTab('docs')}>
          <DocumentTextIcon className="w-5 h-5 mr-2"/>
          Documentation
        </a>
        <a className={`tab ${activeTab === 'support' ? 'tab-active' : ''}`} onClick={() => setActiveTab('support')}>
          <ChatBubbleLeftRightIcon className="w-5 h-5 mr-2"/>
          Support
        </a>
      </div>
      
      {activeTab === 'faq' && (<div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            <h2 className="card-title mb-6">Frequently Asked Questions</h2>
            
            <div className="join join-vertical w-full">
              {faqs.map((faq, index) => (<div key={index} className="collapse collapse-arrow join-item border-b border-base-200">
      ...
      {activeTab === 'docs' && (<div className="card bg-base-100 shadow-xl">
          <div className="card-body">
      ...
      {activeTab === 'support' && (<div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="card bg-base-200">
                <div className="card-body">
                  ...
                  <a href="mailto:proovdbusiness@gmail.com" className="btn btn-primary gap-2">
              ...
              <div className="card bg-base-200">
                <div className="card-body">
                  ...
                  <button className="btn btn-primary gap-2" onClick={() => alert('Live chat feature coming soon!')}>
