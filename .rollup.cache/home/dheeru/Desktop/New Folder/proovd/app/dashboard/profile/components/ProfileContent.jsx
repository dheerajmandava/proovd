      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            <div className="flex flex-col md:flex-row gap-6 mb-6">
              ...
              <div className="flex flex-col items-center">
                <div className="avatar mb-2">
                  <div className="w-24 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                    {userData.image ? (<Image src={userData.image} alt={userData.name} width={96} height={96}/>) : (<div className="flex items-center justify-center w-full h-full bg-primary text-primary-content text-2xl font-bold">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="form-control">
                  ...
                  <input type="text" name="name" value={formData.name} onChange={handleChange} className="input input-bordered w-full" placeholder="Your name"/>
                </div>
                ...
                <div className="form-control">
                  ...
                  <input type="email" name="email" value={formData.email} className="input input-bordered w-full" disabled/>
                  <label className="label">
            ...
            {/* Message display */}
            {message.text && (<div className={`alert ${message.type === 'error' ? 'alert-error' :
            ...
            <div className="card-actions justify-end">
              <button type="submit" className={`btn btn-primary ${isLoading ? 'loading' : ''}`} disabled={isLoading || formData.name === userData.name}>
                Save Changes
              </button>
            </div>
          </form>
        ...
        <div className="card-body">
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="flex justify-between items-center p-4 bg-base-200 rounded-lg">
              ...
              {userData.plan.toLowerCase() === 'free' && (<Link href="/pricing" className="btn btn-primary btn-sm">
                  Upgrade
                </Link>)}
            </div>
