...
export default function WebsiteCard({ website }) {
    ...
    return (<>
      ...
      {/* Setup Code Dialog */}
      {showSetupDialog && (<dialog open className="modal modal-open">
          <div className="modal-box relative bg-white max-w-2xl mx-auto">
            <button className="btn btn-sm btn-circle absolute right-2 top-2" onClick={() => setShowSetupDialog(false)}>
              ✕
            </button>
            ...
            <div className="mt-4">
              ...
              <div className="mt-4 flex justify-end">
                <button className="btn btn-sm btn-primary" onClick={copySetupCode}>
                  {copied ? (<span className="flex items-center">
