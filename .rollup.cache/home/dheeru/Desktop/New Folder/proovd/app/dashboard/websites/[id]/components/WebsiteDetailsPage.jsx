...
export default function WebsiteDetailsPage({ website }) {
    ...
    return (<div className="container mx-auto p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
          ...
          <div className="flex items-center text-gray-500 mt-1">
            <a href={`https://${website.domain}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center hover:text-blue-600">
              {website.domain}
      ...
      <div role="tablist" className="tabs tabs-bordered mb-6">
        ...
        <button role="tab" className={`tab ${activeTab === 'notifications' ? 'tab-active' : ''}`} onClick={() => handleTabChange('notifications')}>
          Notifications
        </button>
        <button role="tab" className={`tab ${activeTab === 'settings' ? 'tab-active' : ''}`} onClick={() => handleTabChange('settings')}>
          Settings
        </button>
      </div>
