...
const STEPS = {
    ...
    VERIFICATION_PREP: 'verification_prep',
    VERIFYING: 'verifying',
...
export default function NewWebsitePage() {
    ...
    async function initializeVerification(domain) {
        try {
            setError('');
    ...
    async function createWebsite() {
        ...
        try {
            ...
            const response = await fetch('/api/websites', {
                ...
                body: JSON.stringify({
                    name: formData.name,
                    domain: (validationResult === null || validationResult === void 0 ? void 0 : validationResult.domain) || formData.domain,
            ...
            if (!response.ok) {
                ...
                if (response.status === 400 && data.verification) {
                    setVerificationDetails(Object.assign(Object.assign({}, data.verification), { instructions: data.details || 'Please verify your domain ownership using the provided token.', token: verificationDetails.token // Keep the existing token, don't use a new one
                     }));
    ...
    function renderVerificationInstructions() {
        ...
        return (<div className="mt-6 border rounded-lg p-6 bg-base-200">
    ...
    function renderVerificationPrep() {
        ...
        <div className="mt-6">
          <button className="btn btn-primary w-full" onClick={() => initializeVerification(formData.domain)}>
    ...
    return (<div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-6">
            ...
            <div className="form-control">
              ...
              <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} placeholder="My Website" className="input input-bordered w-full" disabled={currentStep === STEPS.VALIDATING || currentStep === STEPS.CREATING}/>
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <input type="text" id="domain" name="domain" value={formData.domain} onChange={handleChange} placeholder="example.com" className="input input-bordered w-full" disabled={currentStep === STEPS.VALIDATING || currentStep === STEPS.CREATING}/>
                {(validationResult === null || validationResult === void 0 ? void 0 : validationResult.valid) && (<div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-success flex items-center">
            ...
            <div className="form-control hidden">
              ...
              <select id="verificationMethod" name="verificationMethod" value={formData.verificationMethod} onChange={handleChange} className="select select-bordered w-full" disabled={true}>
            ...
            <div className="pt-4 space-y-4">
              <button type="submit" className="btn btn-primary w-full" disabled={currentStep === STEPS.VALIDATING || currentStep === STEPS.VERIFYING || currentStep === STEPS.CREATING}>
                {(currentStep === STEPS.VALIDATING || currentStep === STEPS.VERIFYING || currentStep === STEPS.CREATING) && (<Loader2 className="h-5 w-5 mr-2 animate-spin"/>)}
                {getButtonText()}
              </button>
