...
import { ArrowTrendingUpIcon, ArrowUpIcon, BellIcon, ChartBarIcon, CodeBracketIcon, CurrencyDollarIcon, UserGroupIcon, GlobeAltIcon, DocumentTextIcon, KeyIcon, CursorArrowRippleIcon } from '@heroicons/react/24/outline';
export default function ClientStatsCard({ title, value, description, icon }) {
