...
export class ProovdPulse {
    ...
    mergeWithDefaults(config) {
        ...
        return {
            ...
            widgetColors: {
                background: ((_a = config.widgetColors) === null || _a === void 0 ? void 0 : _a.background) || '#1e293b',
                text: ((_b = config.widgetColors) === null || _b === void 0 ? void 0 : _b.text) || '#ffffff',
                pulse: ((_c = config.widgetColors) === null || _c === void 0 ? void 0 : _c.pulse) || '#3b82f6',
            },
            customText: {
                activeUserLabel: ((_d = config.customText) === null || _d === void 0 ? void 0 : _d.activeUserLabel) || 'Active Users',
                pulseLabel: ((_e = config.customText) === null || _e === void 0 ? void 0 : _e.pulseLabel) || 'Proovd Pulse',
            },
    ...
    createWidget() {
        var _a, _b, _c, _d, _e;
        if (this.isWidgetVisible || this.widgetElement)
            return;
        ...
        widget.style.backgroundColor = ((_a = this.config.widgetColors) === null || _a === void 0 ? void 0 : _a.background) || '#1e293b';
        widget.style.color = ((_b = this.config.widgetColors) === null || _b === void 0 ? void 0 : _b.text) || '#ffffff';
        ...
        pulse.style.backgroundColor = ((_c = this.config.widgetColors) === null || _c === void 0 ? void 0 : _c.pulse) || '#3b82f6';
    ...
    `;
        ...
        labelElement.textContent = ((_d = this.config.customText) === null || _d === void 0 ? void 0 : _d.activeUserLabel) || 'Active Users';
        // Powered by label
        ...
        poweredBy.textContent = ((_e = this.config.customText) === null || _e === void 0 ? void 0 : _e.pulseLabel) || 'Proovd Pulse';
        // Assemble widget
