 ...
 */
export function useNotifications(websiteId, limit = 10, initialData) {
    const { data, error, isLoading, mutate } = useSWR(websiteId ? `/api/websites/${websiteId}/notifications?limit=${limit}` : null, fetcher, {
...
export function useCreateNotification() {
    ...
    const createNotification = async (websiteId, notificationData) => {
        setIsCreating(true);
        setError(null);
        try {
