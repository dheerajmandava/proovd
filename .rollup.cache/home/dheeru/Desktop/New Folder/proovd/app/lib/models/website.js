...
websiteSchema.methods.recordImpression = async function () {
    try {
        ...
        let todayStats = this.analytics.dailyStats.find((stat) => stat.date === today);
        if (todayStats) {
...
websiteSchema.methods.toResponse = function () {
    ...
    const dailyStats = Array.isArray((_a = this.analytics) === null || _a === void 0 ? void 0 : _a.dailyStats) ?
    ...
    const responseObj = {
        ...
        analytics: {
            totalImpressions: ((_b = this.analytics) === null || _b === void 0 ? void 0 : _b.totalImpressions) || 0,
            totalClicks: ((_c = this.analytics) === null || _c === void 0 ? void 0 : _c.totalClicks) || 0,
            conversionRate: ((_d = this.analytics) === null || _d === void 0 ? void 0 : _d.conversionRate) || 0,
...
websiteSchema.statics.findOneWithRetry = function (filter) {
    return retryDbOperation(() => this.findOne(filter));
};
websiteSchema.statics.findByIdWithRetry = function (id) {
    return retryDbOperation(() => this.findById(id));
};
websiteSchema.statics.findWithRetry = function (filter) {
    return retryDbOperation(() => this.find(filter));
};
websiteSchema.statics.updateOneWithRetry = function (filter, update) {
