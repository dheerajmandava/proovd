...
export async function POST(request, { params }) {
    ...
    try {
        ...
        try {
            ...
            return NextResponse.json({ success: false, error: 'Invalid request format. Expected JSON with clientId.' }, { status: 400 });
        }
        ...
        return NextResponse.json({ success: false, error: 'Failed to generate authentication token' }, {
            status: 500,
            headers: {
