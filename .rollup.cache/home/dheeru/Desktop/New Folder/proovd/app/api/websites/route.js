...
import { createWebsite, getWebsitesByUserId, getWebsiteById, deleteWebsite, getWebsiteByDomain } from '@/app/lib/services';
...
export async function POST(req) {
    ...
    try {
        ...
        const websiteData = {
            ...
            status: 'active',
            verification: Object.assign(Object.assign({}, verification), { status: 'verified', verifiedAt: new Date().toISOString() }),
            settings: {
...
function generateVerificationInstructions(domain, method, token) {
    let instructions = '';
    if (method === 'DNS') {
        instructions = `
