...
const pulseRequestSchema = z.object({
    ...
    engagementData: z.object({
        ...
        focusedElements: z.array(z.object({
            id: z.string(),
            selector: z.string(),
...
export async function GET(request, { params }) {
    try {
        ...
        return NextResponse.json({ success: false, error: 'Failed to fetch pulse data' }, { status: 500 });
    }
}
/**
...
export async function POST(request, { params }) {
    ...
    try {
        ...
        if (!validationResult.success) {
            ...
            return setCorsHeaders(NextResponse.json({ success: false, error: 'Invalid request data' }, { status: 400 }));
        }
        ...
        return setCorsHeaders(NextResponse.json({ success: false, error: 'Failed to record engagement data' }, { status: 500 }));
    }
}
/**
