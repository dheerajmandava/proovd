...
export async function validateDomain(domain) {
    ...
    if (!domainRegex.test(domain)) {
        ...
        return Object.assign(Object.assign({}, result), { error: 'Invalid domain format', details: 'The domain format is not valid. Please enter a correctly formatted domain (e.g., example.com).' });
    }
    try {
        ...
        try {
            ...
            try {
                ...
                return Object.assign(Object.assign({}, result), { error: 'Domain not found', details: 'The domain does not have valid DNS records. Please ensure the domain exists and is properly configured.' });
            }
        }
        ...
        return Object.assign(Object.assign({}, result), { error: 'Validation failed', details: error.message });
    }
}
