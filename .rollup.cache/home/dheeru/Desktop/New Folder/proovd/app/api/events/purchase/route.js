...
import { z } from 'zod';
// Schema for purchase event validation
...
/**
 * API endpoint for tracking purchase events
 */
    ...
    try {
        ...
        if (!validationResult.success) {
            return NextResponse.json({
                success: false,
                error: ((_a = validationResult.error.errors[0]) === null || _a === void 0 ? void 0 : _a.message) || 'Invalid request data'
            }, {
                status: 400,
                headers
            });
        ...
        const { apiKey, productName, productId, price, currency, userName, userEmail, location, sessionId, clientId, customData } = validatedData;
