...
export default function Header() {
    ...
    return (<header className="sticky top-0 z-30 w-full bg-base-100 border-b border-base-200 shadow-sm">
          ...
          <div className="dropdown dropdown-end">
            <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
              <div className="w-10 rounded-full">
                {((_a = session === null || session === void 0 ? void 0 : session.user) === null || _a === void 0 ? void 0 : _a.image) ? (<img src={session.user.image} alt="Profile"/>) : (<div className="bg-primary text-primary-content flex items-center justify-center h-full">
                    <span className="text-lg font-bold">
                      {((_b = session === null || session === void 0 ? void 0 : session.user) === null || _b === void 0 ? void 0 : _b.name) ? session.user.name.charAt(0) : 'U'}
                    </span>
                  </div>)}
              </div>
            </label>
