...
export class UrgencyIndicator extends BaseWidget {
     ...
     */
    addFlashingEffect(element) {
        if (element.classList.contains('proovd-flash-animation'))
            return;
