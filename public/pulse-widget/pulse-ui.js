...
export class PulseWidget {
    ...
    initUI() {
        ...
        if (this.options.theme === 'dark') {
            ...
            window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', (e) => {
                var _a, _b;
                if (e.matches) {
                    (_a = this.container) === null || _a === void 0 ? void 0 : _a.classList.add('proovd-pulse-dark');
                }
                else {
                    (_b = this.container) === null || _b === void 0 ? void 0 : _b.classList.remove('proovd-pulse-dark');
                }
            });
        }
        // Set position
    ...
    `;
        ...
        (_a = this.container.querySelector('.proovd-pulse-content')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
            var _a;
            (_a = this.container) === null || _a === void 0 ? void 0 : _a.classList.toggle('proovd-pulse-expanded');
        });
    }
    /**
    ...
    addStyles() {
        ...
        if (document.getElementById('proovd-pulse-styles'))
            return;
