...
export async function GET(request: NextRequest) {
  try {
    ...
    // 1. API Key Authentication (Public Widget)
    if (apiKey) {
      const { getWebsiteByApiKey } = await import('@/app/lib/services/website.service');
      ...
      // Optional: Check domain restriction if needed
