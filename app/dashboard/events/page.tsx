        ...
        <div className="col-span-2">
          ...
          <div className="card bg-base-200 shadow-sm mb-8">
            <div className="card-body">
              ...
              <CodeSection
                code={`<script src="${process.env.NEXT_PUBLIC_APP_URL || 'https://www.proovd.in'}/api/cdn/events-sdk/${websiteId}.js"></script>`}
                language="html"
              />
...
proovdEvents.trackSignup({
  ...
  location: "New York" // Optional
              ...
              <div className="mb-6">
                ...
                <CodeSection
                  code={`// When a user makes a purchase
